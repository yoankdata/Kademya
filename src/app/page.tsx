...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Chaque professeur fixe librement son prix. Ce tarif est affiché sur sa page de profil et vous donne un ordre d'idée du coût horaire de la prestation. Le prix final et contractuel sera confirmé lors de votre prise de contact et de l'échange direct avec le professeur.",
  },
  {
    question: 'Comment se passe le paiement des cours ?',
    answer:
      'Le paiement se fait directement entre le parent et le professeur (Cash, Mobile Money). Kademya ne prend aucune commission sur les cours.',
  },
  {
    question: "Est-ce que Kademya remplace les cours à l’école ?",
    answer:
      "Non. Kademya complète le travail de l’école. C’est un soutien ciblé pour renforcer les bases et la confiance.",
  },
];

// --- COMPOSANT DECORATIF : GRILLE DE FOND ---
const GridPattern = () => (
  <svg
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
              ...
              <div className="space-y-8 text-center lg:text-left animate-fade-in-up">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Button size="lg" asChild className="h-14 px-8 rounded-full shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all hover:-translate-y-0.5 text-base font-bold">
                    <Link href="/enseignants">
                      Trouver un professeur <ArrowRight className="ml-2 w-5 h-5" />
                    </Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild className="h-14 px-8 rounded-full border-2 hover:bg-secondary/50 transition-all text-base font-semibold">
                    <Link href="/devenir-enseignant">Je veux enseigner</Link>
                  </Button>
                </div>

                {/* SOCIAL PROOF - GLASS PILL */}
              ...
              {/* RIGHT IMAGE - SOPHISTICATED FRAMING */}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
              <div className="space-y-3">
                <h2 className="text-3xl md:text-4xl font-headline font-bold">Les pépites du moment <Sparkles className="inline-block w-8 h-8 text-yellow-400 ml-2" /></h2>
                <p className="text-muted-foreground max-w-2xl text-lg">Des professeurs passionnés, évalués par la communauté.</p>
              </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-white dark:bg-card border border-border/50 rounded-3xl p-8 shadow-sm flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group">
                ...
                <div className="w-full md:w-1/3 bg-gray-50 rounded-2xl p-4 border border-gray-100 rotate-3 group-hover:rotate-0 transition-transform duration-500">
                  ...
                  <div className="mt-4 flex justify-end">
                    <Badge variant="default" className="bg-green-500 hover:bg-green-600"><CheckCircle2 className="w-3 h-3 mr-1" /> Vérifié</Badge>
                  </div>
                </div>
              </div>

              {/* Card 2: Vertical - Paiement */}
              ...
              <div className="md:col-span-1 bg-white dark:bg-card border border-border/50 rounded-3xl p-8 shadow-sm relative overflow-hidden">
                ...
                <p className="text-muted-foreground">Seuls les parents ayant réellement contacté un professeur peuvent laisser un avis.</p>
              </div>
        ...
        <section className="relative py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" variant="secondary" className="h-16 px-10 rounded-full text-primary font-bold text-lg shadow-2xl hover:scale-105 transition-transform" asChild>
