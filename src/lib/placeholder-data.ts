...
export const teachers: Teacher[] = [
  {
    ...
    subjects: ['Mathématiques', 'Physique', 'Préparation BAC'],
    rate: 7500,
    rating: 4.9,
    reviews: 42,
  ...
  },
  {
    ...
    subjects: ['Français', 'Histoire-Géo', 'Préparation BEPC'],
    rate: 5000,
    rating: 4.8,
    reviews: 35,
  ...
  },
  {
    ...
    subjects: ['Chimie', 'SVT', 'Préparation BAC'],
    rate: 8000,
    rating: 4.9,
    reviews: 51,
  ...
  },
  {
    ...
    subjects: ['Anglais', 'Aide aux devoirs (primaire)'],
    rate: 3500,
    rating: 5.0,
    reviews: 60,
    location: 'Yopougon, Abidjan',
    bio: 'J\'apprends aux plus jeunes les bases de l\'anglais et je les accompagne pour leurs devoirs. Je rends l\'apprentissage ludique et intéressant pour tout le monde.',
    experience: '5 ans comme répétitrice et 3 ans comme prof d\'anglais.',
    qualifications: ['Licence d\'Anglais', 'BAFA'],
  ...
  },
  {
    ...
    subjects: ['Art', 'Dessin', 'Aide aux devoirs (primaire)'],
    rate: 3000,
    rating: 4.9,
    reviews: 38,
    location: 'Bingerville, Abidjan',
    bio: 'J\'aide les élèves à libérer leur créativité et à prendre confiance en eux. On explore différentes techniques, du dessin à la peinture, dans une ambiance qui encourage et qui inspire.',
    experience: '7 ans d\'enseignement en arts plastiques et en soutien scolaire.',
